        ...
        <div className="column">
          {activeState === "Data Analysis" && (
            <div className="Show data">
              ...
              <p>
                Advanced data analysis of sales, <br /> margin, and cost to the
                company <br />
                with comprehensive month wise <br /> and year wise visualization
                charts.
              </p>
            </div>
          )}
          ...
          {activeState === "Tree Map" && (
            <div className="Show data">
              ...
              <p>
                Detailed view of distribution based <br /> on popularity, sales,
                and margin <br /> with our informative and visually <br />{" "}
                appealing tree map.{" "}
              </p>
            </div>
          )}
